package com.example.nursecall.ui.home;
...
import com.example.nursecall.Callback.IFirebaseDriverInfoListener;
import com.example.nursecall.Callback.IFirebaseFailedListener;
import com.example.nursecall.Common;
import com.example.nursecall.Model.DriverGeoModel;
import com.example.nursecall.Model.DriverInfoModel;
import com.example.nursecall.Model.GeoQueryModel;
import com.example.nursecall.R;
import com.example.nursecall.databinding.FragmentHomeBinding;
...
public class HomeFragment extends Fragment implements OnMapReadyCallback, LocationListener, IFirebaseDriverInfoListener, IFirebaseFailedListener {
    ...
    public void onDriverInfoLoadSuccess(DriverGeoModel driverGeoModel) {
        ...
        DatabaseReference driverLocation = FirebaseDatabase.getInstance("https://nurse1-ee405-default-rtdb.asia-southeast1.firebasedatabase.app/")
                .getReference(Common.NURSE_LOCATION_REFRENCES)
                .child(driverGeoModel.getKey());
